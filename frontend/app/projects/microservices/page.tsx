...
export const metadata = {
  ...
  description:
    'Case de consultoria: profissional que queria usar IA no trabalho aprendeu a aplicar de forma eficiente.',
};
        ...
        <div className="container-custom relative z-10 py-24">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-neutral-300 leading-relaxed">
              Profissional que queria usar IA no trabalho aprendeu a aplicar de forma eficiente. 
              Aprendeu quando usar, como fazer prompts e quais ferramentas escolher.
            </p>
          </div>
        </div>
      </section>
          ...
          <HudBorder variant="glow" intensity="medium">
            <Card className="p-8 bg-primary-100/30 backdrop-blur-sm border-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <div className="hud-data text-4xl font-display font-bold text-accent-500 mb-2">90%</div>
                  <div className="text-sm text-neutral-400">Eficiência alcançada</div>
                </div>
                <div>
                  <div className="hud-data text-4xl font-display font-bold text-accent-500 mb-2">5h/semana</div>
                  <div className="text-sm text-neutral-400">Tempo economizado</div>
                </div>
                <div>
                  <div className="hud-data text-4xl font-display font-bold text-accent-500 mb-2">A+</div>
                  <div className="text-sm text-neutral-400">Qualidade</div>
                </div>
              </div>
            </Card>
          </HudBorder>
          ...
          <HudBorder variant="glow" intensity="subtle">
            <Card className="p-8 bg-primary-100/30 backdrop-blur-sm border-0">
              ...
              <p className="text-neutral-300 leading-relaxed">
                O profissional queria usar IA no trabalho para ser mais produtivo, mas não sabia por onde começar. 
                Tentou algumas vezes, mas não conseguia resultados satisfatórios porque não sabia:
              </p>
              <ul className="mt-4 space-y-2 text-neutral-300">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="text-accent-500 mt-1" size={18} />
                  <span>Como fazer prompts que realmente funcionam</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="text-accent-500 mt-1" size={18} />
                  <span>Quais ferramentas escolher para cada tarefa</span>
                </li>
              </ul>
            </Card>
          </HudBorder>
          ...
          <HudBorder variant="glow" intensity="subtle">
            <Card className="p-8 bg-primary-100/30 backdrop-blur-sm border-0">
              ...
              <p className="text-neutral-300 leading-relaxed mb-4">
                Através da consultoria, o profissional aprendeu:
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-neutral-100 mb-1">Quando Usar IA</h3>
                    <p className="text-sm text-neutral-400">
                      Aprendeu a identificar tarefas que se beneficiam de IA e quando é melhor fazer manualmente.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-400">
                      Aprendeu técnicas práticas para criar prompts que geram resultados precisos e úteis.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-400">
                      Aprendeu a escolher as ferramentas adequadas (ChatGPT, Claude, etc) para cada tipo de tarefa.
                    </p>
                  </div>
                </div>
              </div>
